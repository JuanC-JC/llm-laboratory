from helpers.streamlit.command_helper import helper_streamlit_chat_command
import requests
	...
	if prompt := st.chat_input("What is up?"):
		...
		with st.chat_message("assistant"):
			...
			with st.spinner("Thinking..."):
				response = requests.post("http://localhost:9007/api/v1/llm/interview", json={
					"answer": prompt,
					"thread_id": thread_id,
...
# def execute_curl_command(answer: str):
#     response = requests.post("http://localhost:9007/api/v1/llm/interview", json={
#         "answer": answer,
#         "thread_id": "189",
